...
# 568 "../../../Program Files/Microchip/xc8/v2.31/include/plib\usart.h"
union USART
{
unsigned char val;
struct
...
volatile unsigned char response[125];
volatile unsigned char received[125];
...
int modoOperacao = 0;
int kp = 16, kd = .05, ki = 2.915;
int tempSetpoint = 40;
float voltPotenciometro;
